...
const videos = [
  ...
  {
    loc: `${SITE_URL}/gitarrenunterricht/`, // URL der Seite, die das Video enthält
  ...
  {
    loc: `${SITE_URL}/keyboardunterricht/`, // URL der Seite, die das Video enthält
  ...
  {
    loc: `${SITE_URL}/harmonielehre/`, // URL der Seite, die das Video enthält
    title: "Notenschrift",
