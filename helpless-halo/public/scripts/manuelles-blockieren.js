  ...
  window.cmp_getXMLLang = function () {
    ...
    if (c && c.getAttribute) {
      ...
      if (typeof a == "string" && a != "") {
        ...
        return b.indexOf(a.toUpperCase()) != -1 ||
          b.indexOf(a.substring(0, 2).toUpperCase()) != -1
          ? a
          : "";
      } else {
        return "";
  ...
  window.cmp_rc = function (c, b) {
    ...
    while (l != "" && f < 100) {
      ...
      if (l.indexOf(";") != -1) {
        ...
        var m = l.substring(l.indexOf("=") + 1, l.length);
      }
      if (c == k) {
        j = m;
        g = true;
  ...
  window.cmp_stub = function () {
    ...
    if (!a.length) {
      ...
      if (a[0] === "ping") {
        ...
        if (a[0] === "getUSPData") {
          a[2](
            { version: 1, uspString: window.cmp_rc("__cmpccpausps", "1---") },
            true
          );
        } else {
          if (a[0] === "getTCData") {
